...
사주 기반 AI 감정 케어 상담 서비스 **마음부적** BE [IT-Cotato/13th-Maeum-Bujeok-BE](https://github.com/IT-Cotato/13th-Maeum-Bujeok-BE)
- Period: `2026.03 ~ 2026.08`
- 회원가입, 홈 요약, 다음 주 흐름 생성 구현
- Grafana/Prometheus 관측 환경 구축 및 보고서 작성
- Stack: `Java` `MySQL` `OpenAI API` `AWS`

읽고, 풀고, 쌓아가는 금융 습관, **FinSight** PM [IT-Cotato/12th-FinSight-BE](https://github.com/IT-Cotato/12th-FinSight-BE)
- Period: `2025.09 ~ 2026.02`
- AI 뉴스 요약과 문맥 맞춤 용어 해설로 금융 지식의 장벽을 허무는 서비스
- 퀴즈·저장·알림 기능으로 꾸준한 학습을 돕고, 금융이 낯선 2030세대의 지식 자산화를 목표로 함
